...
/// <summary>
/// Specifies a data field value is required if another is null or empty.
/// </summary>
...
public class RequiredIfNullAttribute : ValidationAttribute
{
	...
	public RequiredIfNullAttribute(string otherProperty) : base("{0} is required when {1} is null or empty.")
	{
	...
	protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
	{
		...
		if (IsNull(otherValue) && IsNull(value))
		{
