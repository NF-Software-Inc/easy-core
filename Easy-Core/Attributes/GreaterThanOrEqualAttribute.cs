...
/// <summary>
/// Provides an attribute that compares one property is greater than or equal to another.
/// </summary>
...
public class GreaterThanOrEqualAttribute : ValidationAttribute
{
	...
	public GreaterThanOrEqualAttribute(string otherProperty) : base("{0} must be greater than or equal to {1}.")
	{
